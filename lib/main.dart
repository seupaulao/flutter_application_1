...
class MyAppState extends ChangeNotifier {
  ...
  void toggleFavoritos([WordPair? par]) {
    par = par ?? current;
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text("Você tem: ${appState.favoritos.length} itens"),
        ),
        Expanded(
            child: GridView(
          ...
          children: [
            for (var par in appState.favoritos)
              ListTile(
                title: Text(
                  par.asLowerCase,
                  semanticsLabel: par.asPascalCase,
                ),
                leading: IconButton(
                    onPressed: () {
                      appState.removeFavorite(par);
                    },
                    color: theme.colorScheme.primary,
                    icon: Icon(
  ...
  Widget build(BuildContext context) {
    ...
    return ShaderMask(
      ...
      child: AnimatedList(
        ...
        initialItemCount: appState.historia.length,
        itemBuilder: (context, index, animation) {
          final pair = appState.historia[index];
          return SizeTransition(
            sizeFactor: animation,
            child: Center(
              child: TextButton.icon(
                onPressed: () {
                  appState.toggleFavoritos(pair);
                },
